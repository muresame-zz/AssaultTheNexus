package com.gmail.lynx7478.anni.enderFurnace.versions.v1_9_R2;
...
class Furnace_v1_9_R2 extends TileEntityFurnace implements IFurnace
{
    	private EntityPlayer owningPlayer;

    	public Furnace_v1_9_R2(Player p)
    	{
...
//        }
    ...
    public void load(final com.gmail.lynx7478.anni.enderFurnace.api.FurnaceData data)
    {
        ...
        for(int x = 0; x < 3; x++)
            this.setItem(x, org.bukkit.craftbukkit.v1_9_R2.inventory.CraftItemStack.asNMSCopy(items[x]));
