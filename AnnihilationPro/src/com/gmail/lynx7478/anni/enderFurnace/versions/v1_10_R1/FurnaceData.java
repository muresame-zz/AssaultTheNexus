...
class FurnaceData extends com.gmail.lynx7478.anni.enderFurnace.api.FurnaceData
{
    ...
    private static org.bukkit.inventory.ItemStack[] asBukkitCopy(net.minecraft.server.v1_10_R1.ItemStack[] stacks)
    {
        org.bukkit.inventory.ItemStack[] items = new org.bukkit.inventory.ItemStack[stacks.length];
        for(int i = 0; i < items.length; i++)
        {
            items[i] = org.bukkit.craftbukkit.v1_10_R1.inventory.CraftItemStack.asBukkitCopy(stacks[i]);
        }
        return items;
    }
}
