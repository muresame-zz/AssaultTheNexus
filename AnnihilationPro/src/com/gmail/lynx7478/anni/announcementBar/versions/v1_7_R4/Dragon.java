package com.gmail.lynx7478.anni.announcementBar.versions.v1_7_R4;
...
//        }
        ...
        try
        {
            return new PacketPlayOutEntityTeleport(this.id, loc.getBlockX() * 32, loc.getBlockY() * 32, loc.getBlockZ() * 32, (byte) ((int) loc.getYaw() * 256 / 360), (byte) ((int) loc.getPitch() * 256 / 360), false ,false);
        }
        catch (NoSuchMethodError e)
        {
            try
            {
                return PacketPlayOutEntityTeleport.class.getConstructor(Integer.TYPE,Integer.TYPE,Integer.TYPE,Integer.TYPE,Byte.TYPE,Byte.TYPE).newInstance(this.id, loc.getBlockX() * 32, loc.getBlockY() * 32, loc.getBlockZ() * 32, (byte) ((int) loc.getYaw() * 256 / 360), (byte) ((int) loc.getPitch() * 256 / 360));
            }
            catch(Throwable t)
            {
                return null;
