...
class Furnace_v1_12_R1 extends TileEntityFurnace implements IFurnace
{
    	private EntityPlayer owningPlayer;

    	public Furnace_v1_12_R1(Player p)
    	{
    		...
    		//{
                ...
                super.setCustomName("Ender Furnace");
...
//        }
    ...
    public void load(final com.gmail.lynx7478.anni.enderFurnace.api.FurnaceData data)
    {
        ...
        for(int x = 0; x < 3; x++)
            this.setItem(x, org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack.asNMSCopy(items[x]));
