package com.gmail.lynx7478.anni.enderFurnace.versions.v1_12_R1;
...
class FurnaceData extends com.gmail.lynx7478.anni.enderFurnace.api.FurnaceData
{
    ...
    private static org.bukkit.inventory.ItemStack[] asBukkitCopy(net.minecraft.server.v1_12_R1.ItemStack[] stacks)
    {
        ...
        {
            items[i] = org.bukkit.craftbukkit.v1_12_R1.inventory.CraftItemStack.asBukkitCopy(stacks[i]);
        }
        return items;
    }
    
    private static net.minecraft.server.v1_12_R1.ItemStack[] getStacksAsCollection()
    {
    	net.minecraft.server.v1_12_R1.ItemStack[] stacks = new net.minecraft.server.v1_12_R1.ItemStack[furnace.getContents().size()];
    	int num = 0;
    	for(net.minecraft.server.v1_12_R1.ItemStack i : furnace.getContents())
    	{
